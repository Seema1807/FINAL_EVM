...
public class BallottingUnit {
	...
	{
		if(vote==1)
			candidate1.incrementCount();
		if(vote==2)
			candidate2.incrementCount();
		if(vote==3)
			candidate3.incrementCount();
		if(vote==4)
			candidate4.incrementCount();
	}
	...
	private void findWinner()
	    {
	        ...
	        System.out.println("The winner is "+winner.name+" with "+winner.votes+"\n");
	    }
